...
<script type="text/javascript">
	...
	* pageSize:每页展现的记录数
	*
	* pageList方法：就是发出ajax请求到后台，从后台获取最新的市场活动信息列表数据
	* 				通过响应回来的数据，局部刷新市场活动列表
	*
	*调用pageList方法的时期：
	* 	(1)点击左侧菜单的市场活动，需要刷新市场活动列表，调用pageList方法
	* 	(2)添加，修改，删除后，需要刷新市场活动列表，调用pageList方法
	* 	(3)点击查询按钮后，需要刷新市场活动列表，调用pageList方法
	* 	(4)点击分页组件的时候，需要刷新市场活动列表，调用pageList方法
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 81%;">
								<!--
									关于textarea:
										(1)一定要以标签对的形式存在，且标签对要紧紧相连，不能有空格
										(2)textarea虽然是以标签对的形式呈现，但是它也是属于表单元素范畴
											所有的对textarea的取值和赋值操作，应该统一使用val()方法（而不是html()方法）
								-->
